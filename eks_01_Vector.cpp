...
public:                      //  Initierer medlemmer vha. default parameter:
   explicit Vector(const int lengde = 200)  {  data = new T[lengde];
...
int main()  {
  ...
  iVec.push_front(5);   iVec.push_back(6);
  iVec.push_front(4);   iVec.push_back(7);
  iVec.push_front(3);   iVec.push_back(8);
  iVec.push_front(2);   iVec.push_back(9);
  iVec.push_front(1);   iVec.push_front(0);
